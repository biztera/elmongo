...
exports.generateMapping = function (schema) {
	...
	// console.log('generateMapping schema.paths', schema.paths)
		...
		pathArray.forEach(function (pathEntry, i) {
			...
			if (i === pathArray.length - 1) {
				...
				if (pathInfo.instance) {
					currentLocation[pathEntry].type = exports.getElasticsearchTypeFromMongooseTypeString(pathInfo.instance);
				} else if (pathInfo.caster && pathInfo.caster.instance) {
					currentLocation[pathEntry].type = exports.getElasticsearchTypeFromMongooseTypeString(pathInfo.caster.instance);
...
exports.getElasticsearchTypeFromMongooseTypeString = function (type) {
	...
	switch(lowercasedType) {
		...
		case 'array': return 'nested';
		case 'objectid': return 'string';
		case 'mixed': return 'object';
		default: return lowercasedType;
	}
}
